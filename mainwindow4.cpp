...
void MainWindow4::on_pb_supprimer_clicked()
{
...
void MainWindow4::on_pb_modifier_clicked()
{
    int id=ui->le_id_2->text().toInt();
...
void MainWindow4::on_pb_ajouter_clicked()
{
...
void MainWindow4::on_le_id_5_textChanged(const QString &arg1)
{
...
void MainWindow4::on_comboBox_currentIndexChanged(int index)
{
...
void MainWindow4::on_pb_pdf_clicked()
{
QPrinter printer;
...
void MainWindow4::on_tableView_2_clicked(const QModelIndex &index)
{
    QString pdf;
