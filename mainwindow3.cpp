...
void MainWindow3::on_B_ajouter_clicked()
{
...
void MainWindow3::on_pb_supp_clicked()
{
     /*Client C;
...
void MainWindow3::on_pb_modif_clicked()
{
...
void MainWindow3::on_B_pdf_clicked()
{
    QSqlDatabase db;
...
void MainWindow3::on_B_tri_clicked()
{
...
void MainWindow3::on_B_rech_clicked()
{
   Client c;
...
void MainWindow3::mailSent(QString status)
{
...
void MainWindow3::on_pb_stat_clicked()
{
    Client C;
        try{
